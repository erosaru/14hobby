...
<div class="row box-roomuser box-register" style>
	<form id="form_account_bank" class="form-horizontal" method="post" action="<?= base_url()."signup/create"?>">
		<div class="form-group">
			<label class="col-sm-2 control-label text-primary">Formulir Pendaftaran</label>
			<div class="col-sm-10">
			</div>
		</div>
		<div class="form-group">
		...
		<!--
		<div class="form-group">
			<label class="col-sm-2 control-label">*)PIN<br/>(8 character)</label>
			<div class="col-sm-10">
				<div class="col-sm-2" style="padding:0px;">
					<input type="password" value="<? if(isset($data)) echo $data['pin_password'];?>" class="form-control" name="pin_password" id="pin_password" maxlength="8">
				</div>
			</div>
		</div>
		-->
